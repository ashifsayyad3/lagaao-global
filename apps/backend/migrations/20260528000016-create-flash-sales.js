...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('flash_sales', {
      ...
      max_per_user: { type: Sequelize.INTEGER, allowNull: true, comment: 'Max items per user (null = unlimited)' },
    ...
    await queryInterface.createTable('flash_sale_items', {
      id:              { type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true },
      flash_sale_id:   { type: Sequelize.INTEGER, allowNull: false,
      ...
      stock_limit:     { type: Sequelize.INTEGER, allowNull: true, comment: 'Max units available in flash sale' },
